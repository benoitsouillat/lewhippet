...
$text="";
$b_have_info=false;
$wa_form0= waRetrievePostParameter('field_0_wa_id_4ha1yo1hkh0bcxlg');
$text.= "Nom * :\n".$wa_form0."\n\n";
if (($b_have_info==false) && (strlen($wa_form0)>0)) $b_have_info=true;
$wa_form1= waRetrievePostParameter('field_1_wa_id_4ha1yo1hkh0bcxlg');
$text.= "Prénom * :\n".$wa_form1."\n\n";
if (($b_have_info==false) && (strlen($wa_form1)>0)) $b_have_info=true;
$wa_form2= waRetrievePostParameter('field_2_wa_id_4ha1yo1hkh0bcxlg');
$text.= "Votre Email * :\n".$wa_form2."\n\n";
if (($b_have_info==false) && (strlen($wa_form2)>0)) $b_have_info=true;
if (strlen($wa_form2)>0){
$reply_to=$wa_form2;
}
$wa_form3= waRetrievePostParameter('field_3_wa_id_4ha1yo1hkh0bcxlg');
$text.= "Indiquez ci-dessous la raison de votre contact et les question qui en résultent :\n\n";
$wa_form4= waRetrievePostParameter('field_4_wa_id_4ha1yo1hkh0bcxlg');
$text.= $wa_form4."\n\n";
if (($b_have_info==false) && (strlen($wa_form4)>0)) $b_have_info=true;
$wa_form5= waRetrievePostParameter('field_5_wa_id_4ha1yo1hkh0bcxlg');
