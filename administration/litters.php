            ...
            <div class="puppies-admin-container d-flex justify-content-around flex-wrap">
                ...
                ?>
                    <div class="card col-6 co   l-sm-4 col-lg-3 p-2 mt-1">
                        <p>Portée de <?php echo $litter->getMother()->getName() . ' et de ' . $litter->getFather()->getName() ?>
                        </p>
                        <?php
                ...
                alt='Chiot Whippet disponible'>
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn-container d-flex flex-row justify-content-around flex-wrap">
                                <a href="./litters/crud.php?id=<?php echo $litterData->id ?>&repro_id=<?php echo $litter->getMother()->getId() ?>" class="btn btn-success m-2 p-3">Modifier</a>
                                <button onClick="confirmDeleteLitter(<?php echo $litterData->id ?>,  '<?php echo replace_reunion_char($row['name']) ?>')" class="btn btn-outline-danger m-2">Supprimer</button>
                            </div>
                        </div>
                    </div>
                <?php
