    ...
    <main class="d-flex flex-column justify-content-center">
        ...
        if (isset($_SESSION['username'])) {
            if (isset($_SESSION['error'])) {
                ...
                echo "</script>";
                echo "<script>errorReproDisplay();</script>";
                echo "</div>";
                $_SESSION['error'] = [];
            }
        ?>
                    ...
                    <div <?php echo $repro->getSex() == "femelle" ?
                        ...
                        <div class="col-6 col-sm-4">
                            ...
                            <div class="d-flex flex-column justify-content-start align-items-center">
                                <a href="./repros/crud.php?id=<?php echo $reproData->id ?>" class="d-flex justify-content-center"><img class="p-2 m-2 border border-2 border-dark rounded" src="<?php echo $reproData->main_img_path ?> " alt="Lévrier Whippet"></a>
