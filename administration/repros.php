                    ...
                    <div <?php echo $repro->getSex() == "femelle" ?
                        ...
                        <div class="repro_text col-6 col-sm-8 d-flex flex-column justify-content-center align-items-center">
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-evenly col-12 col-md-8">
                                <a href='<?php echo $repro->getLofselect() ?>' class="btn btn-outline-primary m-2 p-2 text-nowrap" target="_blank">Lof
                                    Select</a>
                                <a href="./repros/crud.php?id=<?php echo $reproData->id ?>" class="btn btn-success m-2 p-2">Modifier</a>
                                <button onClick="confirmDeleteRepro(<?php echo $reproData->id ?>,  '<?php echo replace_reunion_char($repro->getName()); ?>')" class="btn btn-outline-danger m-2">Supprimer</button>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4">
                            ...
                            <div class="d-flex flex-column justify-content-start align-items-center">
                                <a href="./repros/crud.php?id=<?php echo $reproData->id ?>" class="d-flex justify-content-center"><img class="p-2 m-2 border border-2 border-dark rounded" src="../repros_img/<?php echo $reproData->main_img_path ?> " alt="Lévrier Whippet"></a>
                                <?php if ($repro->getSex() == 'femelle') {
                                    echo '<a href="./litters/crud.php?id=' . $reproData->id . '" class="btn btn-pink">Nouvelle Portée</a>';
                                } ?>
                            </div>
                        </div>
