                    ...
                    <div class="card col-12 d-flex flex-row justify-content-center align-items-center flex-wrap flex-grow-1">
                        <div class="repro_text col-6 d-flex flex-column justify-content-center">
                            ...
                            <div class="d-flex flex-row justify-content-evenly col-12">
                                <a href="./repros/crud.php?id=<?php echo $reproData->id ?>" class="btn btn-primary m-2 p-3">Modifier</a>
                                <button onClick="confirmDeleteRepro(<?php echo $reproData->id ?>,  '<?php echo replace_reunion_char($repro->getName()); ?>')" class="btn btn-danger m-2">Supprimer</button>
                            </div>
                        </div>
                        <img class="col-4 p-2 m-2 border border-2 border-dark rounded" src="../repros_img/<?php echo $reproData->main_img_path ?> " alt="Lévrier Whippet">
