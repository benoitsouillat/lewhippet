    ...
    <main class="d-flex flex-column justify-content-center">
        ...
        if (isset($_SESSION['username'])) {
            ...
            if (isset($_SESSION['error'])) {
                ...
                echo "</script>";
                echo "<script>errorDisplay();</script>";
                echo "</div>";
            }
        ?>
                    ...
                    <div <?php echo $repro->getSex() == "femelle" ?
                        ...
                        <div class="repro_text col-6 col-sm-8 d-flex flex-column justify-content-center align-items-center">
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-evenly col-12 col-md-8">
                                <a href='<?php echo $repro->getLofselect() ?>' class="btn btn-outline-primary border-2 m-2 p-2 text-nowrap" target="_blank">Lof
                                    Select</a>
                                <a href="./repros/crud.php?id=<?php echo $reproData->id ?>" class="btn btn-outline-success m-2 p-2">Modifier</a>
